      ...
      <Page>
        {(<>
          ...
          <PageHeader
            ...
            subtitle={<a style={{ color: "#0d87b3" }} href="https://github.com/drug-finance/drug-protocol/wiki/Advanced-Pool">About the Advanced Pool</a>}
            title="Unite Druggies by providing Drug coins"
          />
