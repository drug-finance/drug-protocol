    ...
    <Card>
      <CardContent>
        ...
        <div style={{
          ...
          <p>✅Bal-Drug-Dai Pool 95: Drug 95% /Dai 5%<br />
             ✅Bal-Drug-Dai Pool 80: Drug 80%/Dai 20%<br/>

             Circulating Drug Supply：224,746 Drug<br/>
Weekly expected inflation：3%<br/>
Advanced Pool Period: Unlimited<br/>
Bal-Drug-Dai Pool 95：4494.92 Drug/Weekly<br/>
Bal-Drug-Dai Pool 80：2247.46 Drug/Weekly
</p>
        <div style={{
          display: 'flex',
          alignItems: 'center',
          ...
          <StyledLink target="__blank" href="https://github.com/Drug-finance/Drug-protocol/wiki/%F0%9F%9A%A8-Drug---Proposal-2---New-balancer-liquidity-pool">More Info</StyledLink>
        </div>
        </div>
      </CardContent>
    </Card >
